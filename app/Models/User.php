...
class User extends Authenticatable
{
    ...
    protected $fillable = [
        ...
        'hasilujiTB' // Kolom ini sepertinya tidak sesuai dengan konteks `User` dan `fillable`.
                     ...
                     // Umumnya, `hasilujiTB` akan menjadi relasi, bukan kolom langsung di tabel `users`.
                     // Jika `hasilujiTB` sebenarnya adalah `HasilUjiTB` (model), maka ini adalah penamaan yang membingungkan.
    ];
