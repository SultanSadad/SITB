...
{{-- Nama File   = laboran.blade.php --}}
{{-- Deskripsi   = Template layout untuk halaman dashboard laboran --}}
{{-- Dibuat oleh = Sultan Sadad - 331230112 --}}
<!DOCTYPE html>
...
<head>
  ...
  <style>
    /* Styling untuk item sidebar (warna, hover, aktif) */
...
<body class="sidebar-closed">
  <div class="flex h-screen bg-gray-100">
    ...
    <div id="sidebar"
      ...
      <ul class="menu w-full rounded-box px-2 py-4 space-y-1">
        ...
        <script>
          // Menetapkan status 'active' pada tombol logout saat diklik
  ...
  <script>
    ...
    function toggleSidebar() {
      ...
      document.body.classList.toggle('sidebar-open'); // Tambah/hapus kelas untuk overlay
      sidebar.classList.toggle('-translate-x-full'); // Geser sidebar masuk/keluar

      // Mencegah/mengizinkan scrolling body saat sidebar terbuka di mobile
    ...
    document.querySelectorAll('.sidebar-item').forEach(item => {
      item.addEventListener('click', function () {
        if (window.innerWidth < 768) { // Jika lebar layar kurang dari 768px (mobile)
