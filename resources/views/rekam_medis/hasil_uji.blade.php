    ...
    <div class="px-6 mt-4">
        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            <div class="flex justify-between items-center mb-6">
                <!-- Input Pencarian -->
                <form action="{{ url('/rekam-medis/hasil-uji') }}" method="GET">
                ...
                <table class="w-full text-sm text-left text-gray-700">
                    ...
                    @forelse ($hasilUjiList->unique('pasien_id') as $hasil)
                            <tr class="bg-white border-b">
                                ...
                                <td class="px-6 py-4 font-medium text-gray-900 ">{{ $hasil->pasien->nik }}</td>
                                <td class="px-6 py-4 font-medium text-gray-900 ">{{ $hasil->pasien->nama }}</td>
                                <td class="px-6 py-4 ">{{ $hasil->pasien->no_whatsapp }}</td>
                                <td class="px-6 py-4">
