    ...
    <div class="px-6 mt-4">
        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            ...
            <div id="crud-modal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                <div class="bg-white rounded-lg shadow-md w-full max-w-md p-5">
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="text-lg font-semibold text-gray-900">Tambah Laboran</h3>
            ...
            <div id="edit-modal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                <div class="bg-white rounded-lg shadow-md w-full max-w-md p-5">
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="text-lg font-semibold text-gray-900">Edit Laboran</h3>
                        <button type="button" class="text-gray-400 hover:text-gray-900"
                            data-modal-toggle="edit-modal">&times;</button>
                    </div>
                    <form>
                        <div class="mb-4">
                            <label for="nama_laboran" class="block text-gray-700">Nama Laboran</label>
                            <input type="text" id="nama_laboran" name="nama_laboran"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="nip" name="nip" class="mt-1 p-2 w-full border border-gray-300 rounded-lg"
                                required>
                        </div>

                        <div class="mb-4">
                            <label for="no_whatsapp" class="block text-gray-700">No WhatsApp Laboran</label>
                            <input type="text" id="no_whatsapp" name="no_whatsapp"
                                class="mt-1 p-2 w-full border border-gray-300 rounded-lg" required>
                        </div>

                        <div class="mb-4">
                            <label for="email" class="block text-gray-700">Email Laboran</label>
                ...
                <table class="w-full text-sm text-left text-gray-700">
                    ...
                    <tbody>
                        <tr class="bg-white border-b">
                            ...
                            <td class="px-6 py-4">hafivah@email.com</td>
