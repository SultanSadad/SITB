...
@section('rekam_medis')
    <div class="px-6 mt-4">
        <h1 class="font-bold text-2xl mb-4">Data Staf</h1>
            ...
            <div id="crud-modal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                <div class="bg-white rounded-lg shadow-md w-full max-w-sm p-4">
                    <div class="flex items-center justify-between mb-3">
                        <h3 class="text-base font-semibold text-gray-900">Tambah Staf</h3>
                    ...
                    <form>
                        <div class="grid gap-3 mb-3">
                            ...
                            <div>
                                ...
                                <input type="text" id="email" name="email" class="w-full border rounded-lg p-2 text-xs"
                                    required>
                            </div>
                            <div>
